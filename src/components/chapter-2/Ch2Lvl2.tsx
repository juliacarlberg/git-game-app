  ...
  const playersMove = (command: string): string => {
    switch (command) {
      case "git clone":
        ...
        return "Klonat repository hämtat";
    }
    return "";
  };
      ...
      <div className="game-root">
        <div className="level-presentation">
          <div className="character-and-description">
            ...
            />
            <p>
              Men Amanda vill även hämta ner ett redan existerande repository
              för att kuna jobba vidare med ett redan påbörjat projekt. Hjälp
              henne klona ner ett repo.
            </p>
          </div>
        </div>
          ...
          <input
            ...
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                ...
                switch (input) {
                  case "git clone":
                    newOutput += playersMove("git clone");
                    break;
                }
                setOutput(newOutput);
                setInput("");
