...
export const Ch1Lvl3 = () => {
  ...
  const [answerCards, setAnswerCards] = useState<JSX.Element[]>([
    <GitCard key={1} title="git rm" icon="file-minus" desc="Radera fil" />,
  ]);
      ...
      <div className="game-root">
        <div className="level-presentation">
          <div className="character-and-description">
            ...
            />
            <p>
              Det blev lite fel i en av Amandas anteckningsfiler och hon kände
              att den inte behövdes längre. Hjälp henne radera filen med hjälp
              av rätt kommando i terminalen.
            </p>
          </div>
        </div>
